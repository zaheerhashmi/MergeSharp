...
using MergeSharp.UDPConnectionManager;
...
public class UDPConnectionManagerTwoNodesTests : IDisposable
{

    ReplicationManager rm0, rm1;

    public UDPConnectionManagerTwoNodesTests()
    {
        List<string> nodeslist = new List<string>(new string[] { "127.0.0.1:9000", "127.0.0.1:9001" });

        udpConnectionManager cm0 = new udpConnectionManager("127.0.0.1", "9000", nodeslist);
        udpConnectionManager cm1 = new udpConnectionManager("127.0.0.1", "9001", nodeslist);
    ...
    [Fact]
    public void UDPClusterPNCTest2()
    {
    ...
    [Fact]
    public void UDPClusterTPSetTest1()
    {
...
[Collection("collection1")]
public class UDPConnectionManagerMultiNodesTests : IDisposable
{
    ReplicationManager rm0, rm1, rm2, rm3, rm4;

    public UDPConnectionManagerMultiNodesTests()
    {
        ...
        udpConnectionManager cm0 = new udpConnectionManager("127.0.0.1", "9000", nodeslist);
        udpConnectionManager cm1 = new udpConnectionManager("127.0.0.1", "9001", nodeslist);
        udpConnectionManager cm2 = new udpConnectionManager("127.0.0.1", "9002", nodeslist);
        udpConnectionManager cm3 = new udpConnectionManager("127.0.0.1", "9003", nodeslist);
        udpConnectionManager cm4 = new udpConnectionManager("127.0.0.1", "9004", nodeslist);
    ...
    [Fact]
    public void MNUDPClusterPNCTest()
    {
